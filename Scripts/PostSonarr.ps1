...
ForEach ($file in $fileList)
{
	...
	Write-Output "$($time.Invoke()) File $i of $fileCount - $progress%" | Out-File $logPath -Append
		...
		$ffArg17 = "mov_text"
		$ffArg18 = "$newFile"
		$ffArgs = @($ffArg1, $ffArg2, $ffArg3, $ffArg4, $ffArg5, $ffArg6, $ffArg7, $ffArg8, $ffArg9, $ffArg10, $ffArg11, $ffArg12, $ffArg13, $ffArg14, $ffArg15, $ffArg16, $ffArg17, $ffArg18)
		$ffCMD = &$ffmpeg $ffArgs
